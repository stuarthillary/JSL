...
//        System.out.println(getName() + " was assigned the value --> " + myValue + " in assignInitialValue()");
    ...
    protected void setTraceObserver(String name, boolean header) {
        // lazy initialization, make trace report when trace is turned on.
//        System.out.print("getSimulation() = ");
//        System.out.println(getSimulation());
//        File directory = JSL.makeOutputSubDirectory(getSimulation().getName());
        //System.out.println("Simulation name = " + getSimulation().getName());
//        System.out.println("***************** model " + getModel());
//        System.out.println("***************** sim " + getModel().getSimulation());
        ...
        if (myVariableTraceTextReport == null) {
            if (name != null) {
                if (getSimulation() == null) {
                    myVariableTraceTextReport = new VariableTraceTextReport(name + "_Trace", header);
                } else {
                    File directory = JSL.makeOutputSubDirectory(getSimulation().getName());
                    myVariableTraceTextReport = new VariableTraceTextReport(directory, name + "_Trace", header);
                }
            } else {
                if (getSimulation() == null) {
                    myVariableTraceTextReport = new VariableTraceTextReport(getName() + "_Trace", header);
                } else {
                    File directory = JSL.makeOutputSubDirectory(getSimulation().getName());
                    myVariableTraceTextReport = new VariableTraceTextReport(directory, getName() + "_Trace", header);
                }
            }
