...
public class GreatCircleBasedSpatialModel extends SpatialModel {
    ...
    /**
     * The ciruity factor for road networks, see pg 559 of Ballou
     *
     */
    public static final double ROADS = 1.17;

    /**
     * The ciruity factor for rail networks, see pg 559 of Ballou
     *
     */
    ...
    /**
     * The network circuity factor for adjusting the distance.
     *
    ...
    protected final void setCircuityFactor(double circuityFactor) {
        if (circuityFactor <= 0) {
            throw new IllegalArgumentException("The circuity factor must be > 0!");
        }
