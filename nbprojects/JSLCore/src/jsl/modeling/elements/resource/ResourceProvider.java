...
public class ResourceProvider extends SchedulingElement {
     ...
     * @param discipline
     */
    public ResourceProvider(ModelElement parent, ResourceSet set, QueueDiscipline discipline) {
     ...
     * @param discipline
     */
    public ResourceProvider(ModelElement parent, String name, ResourceSet set, QueueDiscipline discipline) {
        super(parent, name);
...
//        myResourceReleasedListener = new ResourceReleasedListener();
     ...
     * @param discipline
     */
    public final void changeQueueDiscipline(QueueDiscipline discipline) {
     ...
     * @return
     */
    public final QueueDiscipline getQueueInitialDiscipline() {
     ...
     * @param discipline
     */
    public final void setQueueInitialDiscipline(QueueDiscipline discipline) {
