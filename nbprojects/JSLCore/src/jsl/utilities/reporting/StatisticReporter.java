...
public class StatisticReporter {
    ...
    public final String DEFAULT_ROW_FORMAT = "%-30s \t %12d \t %12.4f \t %12.4f %n";

    public final String DEFAULT_HEADER_FORMAT = "%-30s \t %12s \t %12s \t %12s %n";
     ...
     * represents a tabular with a maximum number of rows = 60 confidence limit
     *
     ...
     * @return a List of StringBuilders
     */
    public List<StringBuilder> getHalfWidthSummaryReportAsLaTeXTabular(int maxRows, double confLevel) {
        List<StringBuilder> builders = new ArrayList<>();
        if (!myStats.isEmpty()) {
            String hline = "\\hline";
            String f1 = "%s %n";
     ...
     * @return the tables as StringBuilders
     */
    public final List<StringBuilder> getHalfWidthSummaryReportAsLaTeXTables(int maxRows, double confLevel) {
