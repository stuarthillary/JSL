...
/**This class is from David Eck's Introduction to Java Programming (http://math.hws.edu/javanotes)
...
public class TextReader implements AutoCloseable{
     ...
     * @param s the non-null Reader from which the TextReader will read.
     ...
     * @param s the non-null InputStream from which the TextReader will read.
     * @throws NullPointerException if s is null.
     */
